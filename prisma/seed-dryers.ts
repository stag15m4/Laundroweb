...
// ⚠ Verify flagged model numbers against the handwritten sheet before running.
const dryers = [
  // 45 lb stacked — unit 1 (drums 1 & 2)
  // ⚠ First model: "G2G2N05" segment may be "02G2N05" — confirm
  { name: "D45-1", model: "HTT45NKCG2G2N05", serialNumber: "1704049070" },
  { name: "D45-2", model: "HTT45NKCG2G2N05", serialNumber: "1704049070" },
  // 45 lb stacked — unit 2 (drums 3 & 4)
  // ⚠ Confirm whether model differs from unit 1 (G vs B after NKC)
  { name: "D45-3", model: "HTT45NKCB2G2N05", serialNumber: "1704049071" },
  { name: "D45-4", model: "HTT45NKCB2G2N05", serialNumber: "1704049071" },
  ...
  // 30 lb stacked — unit 6 (drums 11 & 12) — ⚠ serial row was scratched out, verify
